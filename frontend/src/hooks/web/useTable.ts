import { BasicTable, TableExpose } from '@/components/Table';
...
export const useTable = <T = any>(config?: UseTableConfig<T>) => {
  ...
  // Table实例
  const tableRef = ref<typeof BasicTable & TableExpose>();

  // ElTable实例
  const elTableRef = ref<ComponentRef<typeof ElTable>>();

  const register = (ref: typeof BasicTable & TableExpose, elRef: ComponentRef<typeof ElTable>) => {
    tableRef.value = ref;
