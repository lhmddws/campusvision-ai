<template>
  <div class="upload-file">
    <el-upload
      ref="fileUpload"
      multiple
      :action="uploadModel.uploadFileUrl + '?updateSupport=' + uploadModel.updateSupport"
    ...
    >
      ...
      <template #tip>
        <div class="el-upload__tip text-center">
          <div v-if="showTip" class="el-upload__tip flex items-center justify-center">
            <el-checkbox v-model="uploadModel.updateSupport" />是否更新已经存在的用户数据
          </div>
